...
import sty from "./PlasmicUserteamNavbar.module.css"; // plasmic-import: P-uBnHr89-in/css
...
function PlasmicUserteamNavbar__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__l9Qpx)}>
        <div
          className={classNames(
            projectcss.all,
            projectcss.__wab_text,
      ...
      <AntdModal
        ...
        closeButtonClassName={classNames({ [sty["pcls_etO9AIKRqkln"]]: true })}
        ...
        maskClosable={true}
        modalContentClassName={classNames({ [sty["pcls_TncM72KjUKBx"]]: true })}
        ...
        wrapClassName={classNames({ [sty["pcls_IKzVy0qaIxOB"]]: true })}
      >
        <div className={classNames(projectcss.all, sty.freeBox__t9HeJ)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
