...
import sty from "./PlasmicUpDownOrder.module.css"; // plasmic-import: vrkob_1Pe1er/css

import ThinArrowTopIconsvgIcon from "./icons/PlasmicIcon__ThinArrowTopIconsvg"; // plasmic-import: LlfKMyVwcd9r/icon
import IconmonstrArrowDownThinsvgIcon from "./icons/PlasmicIcon__IconmonstrArrowDownThinsvg"; // plasmic-import: Z3JtWrI9GF7-/icon
  ...
  return (
    ...
    >
      <ThinArrowTopIconsvgIcon
        className={classNames(projectcss.all, sty.svg__lhOdx, {
          [sty.svgdown__lhOdxoBc1D]: hasVariant($state, "down", "down")
        })}
        role={"img"}
      />

      <IconmonstrArrowDownThinsvgIcon
        className={classNames(projectcss.all, sty.svg__dIsjm, {
          [sty.svgdown__dIsjmoBc1D]: hasVariant($state, "down", "down")
        })}
        role={"img"}
      />
    </div>
